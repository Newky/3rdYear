...
public class Mult extends Aexp {
  ...
  public Aexp reduce(Memory memory) {
    if(!a1.isValue())
      return new Mult(a1.reduce(memory), a2);
    else if(!a2.isValue())
      return new Mult(a1, a2.reduce(memory));
    else 
   ...
   */
  public Code compile() {
    return a2.compile().append(a1.compile()).append(new AM.Mult());
  }
