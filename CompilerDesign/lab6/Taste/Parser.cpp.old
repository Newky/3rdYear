...
bool Parser::StartOf(int s) {
	...
	static bool set[3][33] = {
		...
		{x,T,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,T,x,T, T,T,T,x, T,T,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, T,x,x,x, x,x,x,x, x,T,x,T, T,T,T,x, x,x,x,x, x}
	};
...
void Errors::SynErr(int line, int col, int n) {
	...
	switch (n) {
			...
			case 25: s = coco_string_create(L"\"read\" expected"); break;
			...
			case 36: s = coco_string_create(L"invalid Stat"); break;
